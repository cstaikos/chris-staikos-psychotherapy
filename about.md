...
<section class="section-grid section-grid-two">
  <article class="card">
    ...
    <ul class="clean-list">
      <li>MA Spiritual Care and Psychotherapy (Candidate) - Martin Luther University College / Wilfrid Laurier University (2026)</li>
      <li>BSc - Queen’s University (2012)</li>
    </ul>
  </article>
  <article class="card">
