...
for phrase in ['Registered Psychotherapist (Qualifying)','Trauma processing','Chronic pain','Three hours total','9am','Psychology Today','reveal-email','BSc Cognitive Science','Triphasic Trauma Treatment','Can I book a one-off']:
...
if len(pages)!=6:errors.append(f'Expected 6 pages, found {len(pages)}')
if errors:
